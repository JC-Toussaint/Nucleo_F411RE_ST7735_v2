...
#define ST7735_RES_GPIO_Port GPIOC       // RESET
#define ST7735_RES_Pin       GPIO_PIN_7  // PC7

#define ST7735_CS_GPIO_Port  GPIOB       // CS
#define ST7735_CS_Pin        GPIO_PIN_6  // PB6

#define ST7735_DC_GPIO_Port  GPIOA		 // DC = A0
#define ST7735_DC_Pin        GPIO_PIN_9  // PA9
...
void ST7735_DrawCircle(uint16_t Xpos, uint16_t Ypos, uint16_t Radius, uint16_t color);
void ST7735_DrawEllipse(int Xpos, int Ypos, int XRadius, int YRadius, uint16_t color);
